...
import { $ as $$Hero } from '../chunks/Hero_BWCzu2f3.mjs';
...
}, "/Volumes/echo.ops/maumarketing/src/pages/en/index.astro", void 0);

const $$file = "/Volumes/echo.ops/maumarketing/src/pages/en/index.astro";
const $$url = "/en";
